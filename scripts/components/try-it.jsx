var TryIt  = React.createClass({
    componentWillReceiveProps: function(nextProps){
        if (nextProps.connection && nextProps.connection.options) {
            ...
            var templateUrl = "https://mcastany.auth0.com/authorize?client_id=fUany5j9QpMUPDnbtAoa4nlV8V1C2pUS&response_type=code&connection=" + nextProps.connection.name + "&redirect_uri=" + window.location.toString() + "verify.html";
